...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed w-full z-10 px-4 md:px-14 lg:px-24 py-4 flex items-center justify-between transition-colors duration-300 ${theme} ${
        scrolled
    ...
    >
      ...
      <div
        className={`hidden md:flex items-center justify-end space-x-8 flex-1 text-lg`}
      >
        <button
        ...
        <button className="bg-primary-gradient text-white px-8 py-2">
          Book Call
        </button>
      </div>
